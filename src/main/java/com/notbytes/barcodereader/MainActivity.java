...
import com.notbytes.barcode_reader.barcode.BarcodeCaptureActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, BarcodeReaderFragment.BarcodeReaderListener {
    ...
    private static final int BARCODE_READER_ACTIVITY_REQUEST2 = 1209;
    ...
    private void launchBarCodeActivity2() {
        Intent launchIntent = BarcodeCaptureActivity.getLaunchIntent(this, true, false);
        startActivityForResult(launchIntent, BARCODE_READER_ACTIVITY_REQUEST2);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == BARCODE_READER_ACTIVITY_REQUEST2 && data != null) {
